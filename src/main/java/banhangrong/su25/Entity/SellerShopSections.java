...
public class SellerShopSections {
    ...
    private List<SellerFeaturedProducts> featuredProducts;
    ...
    public SellerShopSections(Long sellerId, SectionType sectionType, String sectionTitle,
                              Integer sortOrder, Boolean isActive, Long filterCategoryId,
                              BigDecimal filterPriceMin, BigDecimal filterPriceMax, Integer maxItems,
    ...
    public BigDecimal getFilterPriceMin() {
        return filterPriceMin;
    }

    public void setFilterPriceMin(BigDecimal filterPriceMin) {
        this.filterPriceMin = filterPriceMin;
    }

    public BigDecimal getFilterPriceMax() {
        return filterPriceMax;
    }

    public void setFilterPriceMax(BigDecimal filterPriceMax) {
        this.filterPriceMax = filterPriceMax;
    }
    ...
    public List<SellerFeaturedProducts> getFeaturedProducts() {
        return featuredProducts;
    }

    public void setFeaturedProducts(List<SellerFeaturedProducts> featuredProducts) {
